...
# import os
# os.environ["FFPLAY_BINARY"] = r"C:\ffmpeg\ffplay.exe"


# import os
# # print("FFMPEG_BINARY:", os.environ.get("FFMPEG_BINARY"))
# print("FFPLAY_BINARY:", os.environ.get("FFPLAY_BINARY"))

#################
# VIDEO LOADING #
#################
# We load our video
video = VideoFileClip(r"C:\Users\Victus\Desktop\YoutubeVideoSummarizer\data\moviepy_10_minutes\resources\bbb.mp4")

# NOTE: No matter the kind of resources, 
# ultimately any clip will be either a VideoClip for any visual element, and an AudioClip for any audio element.
...
) # we can also use string notation with format "HH:MM:SS.MS"
...
# intro_clip.write_videofile("intro_clip.mp4", fps=20)
# bird_clip.write_videofile("bird_clip.mp4", fps=20)
# bunny_clip.write_videofile("bunny_clip.mp4", fps=20)
# rodents_clip.write_videofile("rodents_clip.mp4", fps=20)
# rambo_clip.write_videofile("rambo_clip.mp4", fps=20)
...
# in that case by removing of the clip the part between 00:04:00 to 00:10:00 of the clip, using with_section_cut_out
...
font = r"C:\Users\Victus\Desktop\YoutubeVideoSummarizer\data\moviepy_10_minutes\resources\font\font.ttf"
...
logo_clip = ImageClip(r"C:\Users\Victus\Desktop\YoutubeVideoSummarizer\data\moviepy_10_minutes\resources\logo_bbb.png").resized(width=400)
moviepy_clip = ImageClip(r"C:\Users\Victus\Desktop\YoutubeVideoSummarizer\data\moviepy_10_minutes\resources\logo_moviepy.png").resized(width=300)
...
def sepia_filter(frame: np.ndarray):
  ...
  # Aply the sepia transformation
  # .T is needed because multuiplying matrix of shape (n, m) * (m, k) result in a matrix of shape (n, k)
  # what we want is (n,m), so we must transpose the matrix (m,k) to (k,m)
